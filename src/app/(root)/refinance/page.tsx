...
import { GroupText } from "@/utils/constants";
...
export default function Refinance() {
    ...
    let adGroupData: GroupText = {
        line: "Effortlessly find your Monthly Mortgage Savings in 60 seconds.",
        lines: [
            "Effortlessly find your",
            "Monthly Mortgage Savings",
            "in 60 seconds.",
        ],
        callToAction: "Get my savings!",
        size: "text-3xl",
    };
                ...
                <div className="h-[85dvh] w-full pt-2 flex flex-col justify-between container mx-auto px-5 sm:px-7">
                    <div className="text-center ">
                        ...
                        >
                            ...
                            and best rates. */}
                            Our calculator finds the best rates across all our
                            lending partners.
                        </p>
                    ...
                    >
                        <source src="/refiCalc.mp4" type="video/mp4" />
