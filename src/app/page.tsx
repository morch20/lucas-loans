...
export default function Home() {
    return (
        <main className=" w-full min-h-[90dvh] flex flex-col md:items-stretch md:py-6 md:flex-row md:justify-between h-full ">
            <header className=" flex flex-col items-center md:justify-between md:w-2/5 my-4 md:my-0 h-1/5 md:h-auto">
                <div className="text-center">
                    <h2 className={mina.className + " text-2xl lg:text-3xl"}>
                    ...
                    >
                        Find out how much of a mortgage you can qualify for and
                ...
                <Image
                    ...
                    width={50}
                    height={50}
                    className=" shadow-lg hidden md:block w-44 h-44 lg:w-52 lg:h-52 xl:w-64 xl:h-64 rounded-full"
                />
            </header>
